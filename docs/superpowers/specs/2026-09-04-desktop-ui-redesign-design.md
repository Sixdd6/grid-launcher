...
- Background art: the large cover of the most recently played installed game (falls back
  to the selected card), blurred 40px, 25% opacity, cross-fades over 360ms on change.
