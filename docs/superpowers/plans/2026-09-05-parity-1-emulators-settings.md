...
**Amendment 2026-09-05:** the Connect screen's library-path field also got a Browse… button (`connect-library-path-browse`) in Task 4 because plan 2's `pickers.ts` had already landed; ruling 2's "text input only" no longer applies.
