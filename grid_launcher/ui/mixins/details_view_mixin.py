...
class DetailsViewMixin:
    ...
    def _start_pcgw_lookup_for_game(self, game: dict) -> None:
        from grid_launcher.background.workers import PCGamingWikiWorker
    ...
    def _open_game_details(self, game: dict[str, str], source: str) -> None:
        ...
        if details_achievements_button is None:
            return
        from grid_launcher.server.retroachievements import resolve_ra_game_id
    ...
    def _pcgw_add_manual_path_for_game(self, game: dict, folder: str) -> None:
        from grid_launcher.library.cloud_transfer import normalize_manual_save_path
    ...
    def _perform_game_config_action(self) -> None:
        ...
        if not existing_compat_tool and sys.platform != "win32":
            existing_compat_tool = self._default_compat_tool()
    ...
    def _load_achievements_for_ra_id(self, ra_game_id: int) -> None:
        from grid_launcher.background.workers import RetroAchievementsWorker
    ...
    def _on_achievements_loaded(self, bundle: dict) -> None:
        request_id = bundle.get("request_id")
        achievements = bundle.get("achievements") or []
