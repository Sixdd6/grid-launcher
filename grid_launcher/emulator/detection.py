...
from grid_launcher.core.path import xdg_data_home
...
def detect_installed_flatpak_emulators(
    ...
    for profile in autoprofiles:
        ...
        if app_id == "org.libretro.RetroArch":
            cores_dir = _flatpak_config_root_for_app_id(app_id) / "retroarch" / "cores"
            entry["flatpak_cores_dir"] = str(cores_dir)
