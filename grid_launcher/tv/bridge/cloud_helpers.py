...
from grid_launcher.core.api import api_get_bytes, api_get_json, api_post_multipart_json
from grid_launcher.emulator import (
    ...
    vita3k_save_path_overrides,
    xemu_save_path_overrides,
    xenia_save_path_overrides,
    xenia_state_path_overrides,
)
from grid_launcher.emulator.azahar import azahar_state_path_overrides
from grid_launcher.emulator.selection import EmulatorEntry
...
from grid_launcher.library.cloud_transfer import SUPPORTED_IMAGE_EXTENSIONS

try:
    from grid_launcher.emulator.selection import is_retroarch_emulator_name as _is_retroarch_emulator_name
except ImportError:
...
def resolve_emulator_save_directories(
    ...
    if save_type == "save" and emulator_name_matches_tokens(emulator_name, emulator_entry, "vita3k"):
        return vita3k_save_path_overrides(emulator_path, launch_template, split_configured_paths)
