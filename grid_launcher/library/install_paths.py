...
def candidate_archive_paths_for_game(
    ...
    native_game_dir_value = game.get("native_game_dir", "")
    if isinstance(native_game_dir_value, str) and native_game_dir_value.strip():
        native_game_dir = Path(native_game_dir_value).expanduser()
        candidates.append(native_game_dir / archive_name_for_game(game))
...
def candidate_extracted_dirs_for_game(
    ...
    native_game_dir_value = game.get("native_game_dir", "")
    native_game_dir: Path | None = None
    if isinstance(native_game_dir_value, str) and native_game_dir_value.strip():
        native_game_dir = Path(native_game_dir_value).expanduser()
    ...
    for archive_path in candidate_archive_paths:
        ...
        if native_game_dir is not None:
            candidates.append(native_game_dir / extracted_dir.name)
