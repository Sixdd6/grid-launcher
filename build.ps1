...
# Detect version from git and strip leading "v"
Write-Host "Detecting version from git..." -ForegroundColor Yellow
try {
...
# Generate grid_launcher/version.py
$versionContent = @"
"""Application version (generated by build.ps1)."""
